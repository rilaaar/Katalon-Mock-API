...
def response = WS.sendRequestAndVerify(findTestObject('POST - Create a New User'))
println(response.getResponseBodyContent())

def schemaPath = RunConfiguration.getProjectDir() + '/Include/schemas/create_a_new_user.json'
